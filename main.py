        ...
        for curve in drawings.get("curves", []):
            if "coordinates" in curve:
                ...
                if "bounds_x0" in coords:
                    ...
                    all_y_coords.extend([coords["bounds_y0"], bounds["bounds_y1"]])
    ...
    if remove_non_essential:
        if "metadata" in output_data:
            essential_metadata = {
                ...
                # Toegevoegd: Behoud pdf_dimensions en page_dimensions
        ...
        if "summary" in output_data:
            ...
            # Toegevoegd: Behoud coordinate_bounds
    ...
    try:
        ...
        output = {
            "metadata": {
                ...
                # Toegevoegd: PDF en pagina-dimensies
        ...
        for page_num in range(len(pdf_document)):
            ...
            # Toegevoegd: page_size gebaseerd op page.rect
            page_data = {
                "page_number": page_num + 1,
                "page_size": {
